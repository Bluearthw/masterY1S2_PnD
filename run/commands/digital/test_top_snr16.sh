...
xrun -sv -debug -linedebug +test_sequence=1 +input_file=$WORK_DIR/Matlab_Model/adc_input_16db.txt +output_file=$WORK_DIR/digital/tb/out_char.txt $WORK_DIR/digital/tb/top_test.sv -f $WORK_DIR/digital/rtl/top/top.f -input /esat/studscratch/r0927191/gmsk-project/gmsk-arc/gmsk-group-3/run/restore.tcl
